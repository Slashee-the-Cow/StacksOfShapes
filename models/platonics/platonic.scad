/*
From "Platonic Solids for OpenScad" v0.2
by WilliamAAdams
https://www.thingiverse.com/thing:10725
Licensed Creative Commons Public Domain CC0
*/
...
module makeTetrahedron(rad = 1){
    polyhedron(points = tetrahedron(rad)[0], faces = tetrahedron(rad)[1]);
}

module makeHexahedron(rad = 1){
    polyhedron(points = hexahedron(rad)[0], faces = hexahedron(rad)[1]);
}

module makeOctahedron(rad = 1){
    polyhedron(points = octahedron(rad)[0], faces = octahedron(rad)[1]);
}

module makeDodecahedron(rad = 1){
    polyhedron(points = dodecahedron(rad)[0], faces = dodecahedron(rad)[1]);
}

module makeIcosahedron(rad = 1){
    polyhedron(points = icosahedron(rad)[0], faces = icosahedron(rad)[1]);
}
